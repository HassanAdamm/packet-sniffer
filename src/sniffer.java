...
Packet packet;
   ...
   public void CapturePackets() {
    ...
    private void initComponents() {
        ...
        filter_options.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---", "TCP", "UDP", " " }));
...
//outputText.setText("");
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
       ...
       for(int i=0;i<SnifferForm.No;i++)
    ...
    private javax.swing.JComboBox<String> filter_options;
